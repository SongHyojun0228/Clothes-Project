...
다양한 패션 정보와 스타일을 공유하고 의견을 나눌 수 있는 공간을 구현해보고 싶었고, 그 과정에서 Node.js와 Express를 이용해 게시판 기능을 직접 설계하고 구현하면서 웹 개발의 기본 흐름을 익히는 데 큰 도움이 되었습니다.
...
## 📌 성장점
AJAX를 활용한 댓글, 좋아요 기능 구현을 통해 새로고침 없이 동작하는 웹페이지를 만들 수 있었습니다./p>
